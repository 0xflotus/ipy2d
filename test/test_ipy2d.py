...
def test_random_examples():
    assert from_4("0.0.0.1") == 1, "Should be 1"
    assert from_6("::1") == 1, "Should be 1"
    assert (
        from_6("2001:4860:4860::8888") == 42541956123769884636017138956568135816
    ), "Should be 42541956123769884636017138956568135816"

    assert to_4(5) == "0.0.0.5", "Should be 0.0.0.5"
    assert (
        to_6(42541956123769884636017138956568135817)
        == "2001:4860:4860:0000:0000:0000:0000:8889"
    ), "Should be 2001:4860:4860:0000:0000:0000:0000:8889"
    assert (
        to_6(0x20014860486000000000000000008889)
        == "2001:4860:4860:0000:0000:0000:0000:8889"
    ), "Should be 2001:4860:4860:0000:0000:0000:0000:8889"
    assert (
        to_6(from_6("0000:0000:0000:dead:beef:0000:0000:0000"))
